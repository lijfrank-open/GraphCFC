...
parser.add_argument('--windowp', type=int, default=18, help='context window size for constructing edges in graph model for past utterances.if windowf=0, DAG')
parser.add_argument('--windowf', type=int, default=18, help='context window size for constructing edges in graph model for future utterances')
...
parser.add_argument('--hidesize', type=int, default=200, help='')
...
parser.add_argument('--agg_type', default='BiGRU', help='method to agg: GRU/BiGRU/BiLSTM/sum-product1/sum')
...
parser.add_argument('--use_relation', action='store_true', default=True, help='whether to use relation embedding')
...
parser.add_argument('--loss_type', default='auto_multi_loss', help='use single_loss, manual_multi_loss, auto_multi_loss')
